...
export const renameConversation = async (id: string,
    renameConversationBody: RenameConversationBody, options?: RequestInit): Promise<Conversation> => {
...
export const getRenameConversationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof renameConversation>>, TError,{id: string;data: BodyType<RenameConversationBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof renameConversation>>, TError,{id: string;data: BodyType<RenameConversationBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof renameConversation>>, {id: string;data: BodyType<RenameConversationBody>}> = (props) => {
          const {id,data} = props ?? {};
...
export const useRenameConversation = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof renameConversation>>, TError,{id: string;data: BodyType<RenameConversationBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: string;data: BodyType<RenameConversationBody>},
        TContext
      > => {
...
export const sendMessage = async (id: string,
    sendMessageBody: SendMessageBody, options?: RequestInit): Promise<MessagePair> => {
